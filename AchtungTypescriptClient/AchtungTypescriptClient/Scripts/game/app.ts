...
class AchtungTypescript {
    ...
    startLocal() {
        const localPlayers = [new ClientPlayer('local_1', 'blue', localGameVariables.playerSpeed, localGameVariables.playerSize, < ClientTypings.KeyboardKeys > { left: KeyboardStates.A, right: KeyboardStates.D }),
